...
public class ShowProjectToolTest {
    ...
    @Test
    public void testExecute_ProjectWithoutDescription() {
    ...
    @Test
    public void testExecute_ProjectWithoutRequirements() {
    ...
    public void testGetDescription() {
        assertTrue(showProjectTool.getDescription().contains("Show details"));
    }
    
    @Test
    public void testGetUri() {
        assertTrue(showProjectTool.getUri().contains("show-project"));
    }
}
